    ...
    <div>
      <section className="bg-hero-gradient">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:py-24">
          ...
          <p className="mt-4 max-w-xl text-ink-muted">
            เลือกไอดีจากสต๊อกจริง ตรวจสอบสเปกครบก่อนตัดสินใจ ถูกใจไอดีไหนกดแชทคุยกับแอดมินได้ทันที ไม่ต้องสมัครสมาชิก
      ...
      <section className="mx-auto max-w-6xl px-4 py-14">
        <div className="grid gap-4 sm:grid-cols-3">
          {[
            { title: "ตรวจสอบได้ทุกรายการ", desc: "ระบุแรงค์ ฮีโร่ สกิน และยอดเพชรคงเหลือชัดเจนก่อนตัดสินใจ" },
            { title: "แชทตรงกับแอดมิน", desc: "ไม่ต้องสมัครสมาชิกหรือกรอกข้อมูล กดปุ่มเดียวเด้งไปคุยกับแอดมินได้เลย" },
            { title: "นัดโอน-รับไอดีสะดวก", desc: "ตกลงราคาและรับไอดีกับแอดมินโดยตรงทาง Facebook ทุกวัน 10:00–24:00 น." },
          ].map((item) => (
